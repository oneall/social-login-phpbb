...
$lang = array_merge ($lang, array (
	...
	'OA_SOCIAL_LOGIN_DO_VALIDATION_ASK' => "Demander aux nouveaux utilisateurs de confirmer leur nom d’utilisateur et adresse mél ?",
	'OA_SOCIAL_LOGIN_DO_VALIDATION_DESC' => "Si activé, les nouveaux utilisateurs sont invités à compléter ou confirmer leur nom d’utilisateur et adresse mél.",
	'OA_SOCIAL_LOGIN_DO_VALIDATION_NO' => "Désactiver la confirmation de profil",
	'OA_SOCIAL_LOGIN_DO_VALIDATION_YES' => "Activer la confirmation de profil",
	'OA_SOCIAL_LOGIN_VALIDATION_FORM_HEADER' => "Confirmer votre nom d’utilisateur et adresse mél.",
	'OA_SOCIAL_LOGIN_VALIDATION_FORM_DESC' => "L’administrateur demande que vous confirmiez ou complétiez votre nom d'utilisateur et adresse mél.",
	'OA_SOCIAL_LOGIN_VALIDATION_FORM_EMAIL_EXPLAIN' => "Acceptez ou modifiez votre adresse mèl.",
	'OA_SOCIAL_LOGIN_VALIDATION_FORM_EMAIL_NONE_EXPLAIN' => "Votre adresse mél manque à votre profil, veuillez la renseigner içi.",
	'OA_SOCIAL_LOGIN_VALIDATION_SESSION_ERROR' => "Information de session absente.",
