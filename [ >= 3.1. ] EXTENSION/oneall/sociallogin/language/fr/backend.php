...
$lang = array_merge ($lang, array (
	'OA_SOCIAL_LOGIN_ACP' => '“Social connexion” OneAll',
	'OA_SOCIAL_LOGIN_ACP_SETTINGS' => 'Paramètres',
	'OA_SOCIAL_LOGIN_DISPLAY_LOC' => 'Ou est-ce-que vous voulez afficher Social Login?',
	'OA_SOCIAL_LOGIN_INDEX_PAGE' => 'Page d’accueil du forum',
	'OA_SOCIAL_LOGIN_INDEX_PAGE_ENABLE' => 'Activer le “social connexion” sur la page d’accueil du forum ?',
	'OA_SOCIAL_LOGIN_INDEX_PAGE_ENABLE_DESC' => 'Si activé, le “social connexion” sera affiché sur la page d’accueil du forum.',
	'OA_SOCIAL_LOGIN_INDEX_PAGE_YES' => 'Activer',
	'OA_SOCIAL_LOGIN_INDEX_PAGE_NO' => 'Désactiver',
	'OA_SOCIAL_LOGIN_INDEX_PAGE_CAPTION' => 'Légende',
	'OA_SOCIAL_LOGIN_INDEX_PAGE_CAPTION_DESC' => 'Ce titre sera affiché au-dessus des icônes du “social connexion” sur la page d’accueil du forum.',
	'OA_SOCIAL_LOGIN_LOGIN_PAGE' => 'Page de connexion du forum',
	'OA_SOCIAL_LOGIN_LOGIN_PAGE_ENABLE' => 'Activer le “social connexion” sur la page de connexion du forum ?',
	'OA_SOCIAL_LOGIN_LOGIN_PAGE_ENABLE_DESC' => 'Si activé, le “social connexion” sera affiché sur la page de connexion du forum.',
	'OA_SOCIAL_LOGIN_LOGIN_PAGE_YES' => 'Activer',
	'OA_SOCIAL_LOGIN_LOGIN_PAGE_NO' => 'Désactiver',
	'OA_SOCIAL_LOGIN_LOGIN_PAGE_CAPTION' => 'Légende',
	'OA_SOCIAL_LOGIN_LOGIN_PAGE_CAPTION_DESC' => 'Ce titre sera affiché au-dessus des icônes du “social connexion” sur la page de connexion du forum.',
	'OA_SOCIAL_LOGIN_REGISTRATION_PAGE' => 'Page d’inscription du forum',
	'OA_SOCIAL_LOGIN_REGISTRATION_PAGE_ENABLE' => 'Activer le “social connexion” sur la page d’inscription du forum ?',
	'OA_SOCIAL_LOGIN_REGISTRATION_PAGE_ENABLE_DESC' => 'Si activé, le “social connexion” sera affiché sur la page d’inscription du forum.',
	...
	'OA_SOCIAL_LOGIN_REGISTRATION_PAGE_CAPTION_DESC' => 'Ce titre sera affiché au-dessus des icônes du “social connexion” sur la page d’inscription du forum.',
	...
	'OA_SOCIAL_LOGIN_PROFILE_TITLE' => '“Social connexion”',
	...
	'OA_SOCIAL_LOGIN_INTRO' => 'Permet aux utilisateurs de se connecter et de s’enregistrer avec les réseaux sociaux tels que Twitter, Facebook, LinkedIn, Hyves, VKontakte, Google et Yahoo et bien d’autres.<br /> Le “social connexion” <strong>permet d’accroitre le nombre de nouveaux utilisateurs</strong> en simplifiant l’enregistrement et en fournissant des permissions sociales de bases <strong>récupérées depuis les profils des réseaux sociaux</strong>. Le “social connexion” s’intègre à votre système d’enregistrement actuel ainsi vous et vos utilisateurs n’auront pas à recommencer un nouveau forum.',
	'OA_SOCIAL_LOGIN_TITLE' => '“Social connexion” OneAll',
	...
	'OA_SOCIAL_LOGIN_CREATE_ACCOUNT_FIRST' => 'Pour utiliser le “social connexion”, vous devez d’abord créer un compte gratuit sur <a href="https://app.oneall.com/signup/" class="external">http://www.oneall.com</a> et configurer un site.',
	...
	'OA_SOCIAL_LOGIN_DO_ENABLE' => 'Activer le “Social connexion” ?',
	'OA_SOCIAL_LOGIN_DO_ENABLE_DESC' => 'Permet de désactiver temporairement “Social connexion” sans avoir à l’enlever.',
