...
*/
class oneall extends \phpbb\auth\provider\base
{
    /**
    ...
    */
     ...
     */
    public function __construct(\phpbb\db\driver\driver_interface $db, \phpbb\config\config $config, \phpbb\passwords\manager $passwords_manager, \phpbb\request\request $request
, \phpbb\user $user, \Symfony\Component\DependencyInjection\ContainerInterface $phpbb_container, $phpbb_root_path, $php_ext)
    {
        $this->db = $db;
        $this->config = $config;
    ...
    /*********************************************************************
     * login and auto_login member functions are taken from the 
     * phpbb/auth/provider/db.php file to allow local logins in case the
     * user wants to log in normally.
     *********************************************************************/
	/**
	 * {@inheritdoc}
	 */
