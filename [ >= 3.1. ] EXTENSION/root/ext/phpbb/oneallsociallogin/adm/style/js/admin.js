		...
		$(document).ready(function($) {
			...
			$('#oa_social_login_autodetect_api_connection_handler').click(function() {
				...
				if ($(button).hasClass('working') === false) {
					...
					var data = {};
					var sid = $('#sid').html();
					var ajaxurl = 'index.php?sid=' + sid + '&i=-phpbb-oneallsociallogin-acp-oneallsociallogin_module&mode=settings&task=autodetect_api_connection';
			...
			$('#oa_social_login_test_api_settings').click(function() {
				...
				if ($(button).hasClass('working') === false) {
					...
					var ajaxurl = 'index.php?sid=' + sid + '&i=-phpbb-oneallsociallogin-acp-oneallsociallogin_module&mode=settings&task=verify_api_settings';
